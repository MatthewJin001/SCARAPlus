function [ ] = xyzplotc(r,t,l)
%plotxyz
lineW=1.5;
u1=t;
u2=r*[l;0;0]+t;
u=[u1 u2];
% cone3(u2,0.2*l*(u2-u1)/norm(u2-u1)+u2,0.05*l,'r')
vx=u(1,:);
vy=u(2,:);
vz=u(3,:);
plot3(vx,vy,vz,'r-','linewidth',lineW)
hold on
u1=t;
u2=r*[0;l;0]+t;
u=[u1 u2];
% cone3(u2,0.2*l*(u2-u1)/norm(u2-u1)+u2,0.05*l,'g')
vx=u(1,:);
vy=u(2,:);
vz=u(3,:);
plot3(vx,vy,vz,'g-','linewidth',lineW)
u1=t;
u2=r*[0;0;l]+t;
u=[u1 u2];
% cone3(u2,0.2*l*(u2-u1)/norm(u2-u1)+u2,0.05*l,'b')
vx=u(1,:);
vy=u(2,:);
vz=u(3,:);
plot3(vx,vy,vz,'b-','linewidth',lineW)
end
