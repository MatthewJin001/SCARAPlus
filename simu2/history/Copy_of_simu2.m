...
xticklabels({})
title('\mathbf{e}_X^{\top}\cdot{^\mathcal{C}\mathbf{v}}/mm')
nexttile
plot(beta1,'LineWidth',LW);
xticklabels({})
title('\mathbf{e}_X^{\top}\cdot{\mathbf{\beta}}/mm')


nexttile
plot(v2,'LineWidth',LW);
title('\mathbf{e}_Y^{\top}\cdot{^\mathcal{C}\mathbf{p}}/mm')
nexttile
...
xticklabels({})
title('\mathbf{e}_X^{\top}\cdot{^\mathcal{C}\mathbf{p}}/mm')
nexttile
...
xticklabels({})
title('\mathbf{e}_Z^{\top}\cdot{^\mathcal{C}\mathbf{p}}/mm')
